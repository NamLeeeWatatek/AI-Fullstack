...
// âœ… Memoize MessageBubble to prevent unnecessary re-renders
export const MessageBubble = React.memo(function MessageBubble({
    ...
    // - 'user' = Customer (from Facebook/Instagram) â†’ LEFT side
    // - 'assistant' = Agent/Bot (our response) â†’ RIGHT side
    const isCustomer = message.role === 'user';
    const isAgent = message.role === 'assistant';

    // âœ… FIX: Safe date formatting - memoize
    ...
    // âœ… Show "You" badge for agent messages
