...
export function WidgetAppearanceSettings({ botId, currentSettings, onSave }: Props) {
    const [settings, setSettings] = useState<WidgetAppearanceSettings>({
        ...
        welcomeMessage: currentSettings?.welcomeMessage || 'Xin chÃ o! TÃ´i cÃ³ thá»ƒ giÃºp gÃ¬ cho báº¡n?',
        placeholderText: currentSettings?.placeholderText || 'Nháº­p tin nháº¯n...',
    ...
    useEffect(() => {
        ...
        const changed =
            ...
            settings.welcomeMessage !== (currentSettings.welcomeMessage || 'Xin chÃ o! TÃ´i cÃ³ thá»ƒ giÃºp gÃ¬ cho báº¡n?') ||
            settings.placeholderText !== (currentSettings.placeholderText || 'Nháº­p tin nháº¯n...') ||
