...
export class Initial1765254665618 implements MigrationInterface {
  name = 'Initial1765254665618';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "node_type" ("id" character varying NOT NULL, "label" character varying NOT NULL, "category" character varying NOT NULL, "icon" character varying NOT NULL, "color" character varying NOT NULL, "description" character varying NOT NULL, "isPremium" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT true, "properties" jsonb NOT NULL, "executionConfig" jsonb, "inputSchema" jsonb, "outputSchema" jsonb, "sortOrder" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_21db5612f4dbffd0e468819c4ae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "knowledge_base" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workspace_id" uuid, "name" character varying NOT NULL, "description" character varying, "chunk_size" integer NOT NULL DEFAULT '1000', "chunk_overlap" integer NOT NULL DEFAULT '200', "embedding_model" character varying NOT NULL DEFAULT 'text-embedding-004', "similarity_threshold" double precision NOT NULL DEFAULT '0.7', "top_k" integer NOT NULL DEFAULT '5', "live_version_id" uuid, "created_by" uuid NOT NULL, "icon" character varying, "color" character varying NOT NULL DEFAULT '#3B82F6', "is_public" boolean NOT NULL DEFAULT false, "total_documents" integer NOT NULL DEFAULT '0', "total_size" bigint NOT NULL DEFAULT '0', "tags" text, "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_19d3f52f6da1501b7e235f1da5c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "flow" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "status" character varying NOT NULL DEFAULT 'draft', "version" integer NOT NULL DEFAULT '1', "nodes" jsonb NOT NULL DEFAULT '{"nodes":[],"edges":[]}', "edges" jsonb NOT NULL DEFAULT '[]', "ownerId" uuid, "teamId" uuid, "visibility" character varying NOT NULL DEFAULT 'private', "published" boolean NOT NULL DEFAULT false, "tags" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c2ad4a3e86394cd9bb7a80a228" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
