...
export class Init1764598937746 implements MigrationInterface {
  name = 'Init1764598937746';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "workspace_member" ("workspace_id" uuid NOT NULL, "user_id" uuid NOT NULL, "role" character varying NOT NULL DEFAULT 'member', "joined_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0eab76d5a9c509930a9f3d7a104" PRIMARY KEY ("workspace_id", "user_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "knowledge_base" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workspace_id" uuid NOT NULL, "name" character varying NOT NULL, "description" character varying, "chunk_size" integer NOT NULL DEFAULT '1000', "chunk_overlap" integer NOT NULL DEFAULT '200', "embedding_model" character varying NOT NULL DEFAULT 'text-embedding-004', "similarity_threshold" double precision NOT NULL DEFAULT '0.7', "top_k" integer NOT NULL DEFAULT '5', "live_version_id" uuid, "created_by" uuid NOT NULL, "icon" character varying, "color" character varying NOT NULL DEFAULT '#3B82F6', "is_public" boolean NOT NULL DEFAULT false, "total_documents" integer NOT NULL DEFAULT '0', "total_size" bigint NOT NULL DEFAULT '0', "tags" text, "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_19d3f52f6da1501b7e235f1da5c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f39683bc3c87e158ee5afffdba" ON "knowledge_base" ("workspace_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "kb_folder" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "knowledge_base_id" uuid NOT NULL, "parent_id" uuid, "name" character varying NOT NULL, "path" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b9ecced097312ba705828ad18f6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b29ab77551196c32dbf229c477" ON "kb_document" ("status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_fe4cabddacd8bea491dda43610" ON "kb_document_version" ("document_id", "version") `,
    );
    await queryRunner.query(
      `CREATE TABLE "rag_feedback" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "message_id" uuid NOT NULL, "rating" integer NOT NULL, "comment" text, "created_by" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ac681653e6fd694d603a4674999" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ba6efe5217f9ccca718f480f96" ON "rag_feedback" ("message_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_4f4af60aee1133f7e8a8043cfb" ON "kb_chunk" ("vector_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2b11e5e325ab1cf316a7b1d2b2" ON "kb_chunk" ("embedding_status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bot" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workspace_id" uuid NOT NULL, "name" character varying NOT NULL, "description" character varying, "avatar_url" character varying, "default_language" character varying NOT NULL DEFAULT 'en', "timezone" character varying NOT NULL DEFAULT 'UTC', "status" character varying NOT NULL DEFAULT 'draft', "created_by" uuid NOT NULL, "icon" character varying DEFAULT 'FiMessageSquare', "is_active" boolean NOT NULL DEFAULT true, "flow_id" uuid, "system_prompt" text, "functions" text, "function_config" jsonb, "ai_model" character varying, "ai_config" jsonb, "knowledge_base_ids" text, "enable_auto_learn" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bc6d59d7870eb2efd5f7f61e5ca" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e45750f69e8b0280974c298b82" ON "bot" ("workspace_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "flow_version" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bot_id" uuid NOT NULL, "version" integer NOT NULL, "name" character varying, "description" character varying, "status" character varying NOT NULL DEFAULT 'draft', "published_at" TIMESTAMP, "created_by" uuid NOT NULL, "flow" jsonb NOT NULL, "is_published" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2f20a52dcddf98d3fafe621a9f5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bot_knowledge_base" ("bot_id" uuid NOT NULL, "knowledge_base_id" uuid NOT NULL, "priority" integer NOT NULL DEFAULT '1', "rag_settings" jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_159a73113affedc7d5638ce6c2b" PRIMARY KEY ("bot_id", "knowledge_base_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_ai_provider" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "provider" character varying NOT NULL, "display_name" character varying NOT NULL, "api_key_encrypted" character varying, "model_list" text, "is_active" boolean NOT NULL DEFAULT true, "is_verified" boolean NOT NULL DEFAULT false, "verified_at" TIMESTAMP, "quota_used" integer NOT NULL DEFAULT '0', "last_used_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f6697478228ff5e82cdc7a47cc7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5865ffc4f3d6a4b21db251bfce" ON "user_ai_provider" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "workspace_ai_provider" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workspace_id" uuid NOT NULL, "provider" character varying NOT NULL, "display_name" character varying NOT NULL, "api_key_encrypted" character varying, "model_list" text, "is_active" boolean NOT NULL DEFAULT true, "quota_used" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_54cdaa57b423e7866b942659564" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2399c8277c3c04cecec79f5f98" ON "workspace_ai_provider" ("workspace_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "knowledge_base" ADD CONSTRAINT "FK_a47b1575e8f2c2cc377a9cc40f0" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "kb_folder" ADD CONSTRAINT "FK_161009326bd37f66e42195ef61d" FOREIGN KEY ("parent_id") REFERENCES "kb_folder"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "kb_document" ADD CONSTRAINT "FK_e0a623b6a641e6cb084ffd1ae8c" FOREIGN KEY ("folder_id") REFERENCES "kb_folder"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "kb_document" ADD CONSTRAINT "FK_e98a2d3732711bfa802d8de314e" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "kb_document_version" ADD CONSTRAINT "FK_e828d02073fa95cca8fda16ad60" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "rag_feedback" ADD CONSTRAINT "FK_8b0eac5cbe2159dc9070a1e52be" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "kb_chunk" ADD CONSTRAINT "FK_9f2ef0102da59042a85e6f21fb0" FOREIGN KEY ("documentId") REFERENCES "kb_document"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "conversation" ADD CONSTRAINT "FK_aaebf689e2996177947248df934" FOREIGN KEY ("bot_id") REFERENCES "bot"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "channel" ADD CONSTRAINT "FK_bf9c25c4068a5913cf57cb3276e" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_ai_provider" ADD CONSTRAINT "FK_5865ffc4f3d6a4b21db251bfce5" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "workspace_ai_provider" ADD CONSTRAINT "FK_2399c8277c3c04cecec79f5f98e" FOREIGN KEY ("workspace_id") REFERENCES "workspace"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "workspace_ai_provider" DROP CONSTRAINT "FK_2399c8277c3c04cecec79f5f98e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_ai_provider" DROP CONSTRAINT "FK_5865ffc4f3d6a4b21db251bfce5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "channel" DROP CONSTRAINT "FK_bf9c25c4068a5913cf57cb3276e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "kb_chunk" DROP CONSTRAINT "FK_9f2ef0102da59042a85e6f21fb0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rag_feedback" DROP CONSTRAINT "FK_8b0eac5cbe2159dc9070a1e52be"`,
    );
    await queryRunner.query(
      `ALTER TABLE "kb_document_version" DROP CONSTRAINT "FK_e828d02073fa95cca8fda16ad60"`,
    );
    await queryRunner.query(
      `ALTER TABLE "kb_document_version" DROP CONSTRAINT "FK_c348ba14b55e6e3452b050a6129"`,
    );
    await queryRunner.query(
      `ALTER TABLE "kb_document" DROP CONSTRAINT "FK_e98a2d3732711bfa802d8de314e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "knowledge_base" DROP CONSTRAINT "FK_a47b1575e8f2c2cc377a9cc40f0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2399c8277c3c04cecec79f5f98"`,
    );
    await queryRunner.query(`DROP TABLE "workspace_ai_provider"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5865ffc4f3d6a4b21db251bfce"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2b11e5e325ab1cf316a7b1d2b2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4f4af60aee1133f7e8a8043cfb"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ba6efe5217f9ccca718f480f96"`,
    );
    await queryRunner.query(`DROP TABLE "rag_feedback"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fe4cabddacd8bea491dda43610"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b29ab77551196c32dbf229c477"`,
    );
    await queryRunner.query(
